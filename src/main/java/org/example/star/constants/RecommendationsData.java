...
public enum RecommendationsData {
    INVEST500("Invest 500",
    ...
    RecommendationsData(String name, UUID id, String text) {
        this.name = name;
        this.id = id;
        this.text = text;
    }
